...
// wrapper and silently breaks `paths`/`import`/`loader` resolution — see
// docs/refactor-progress/T13-ui-example.md for the full trace. Exporting the
// flat profile object directly (no inner "default" key) is the correct shape
// for this project's single ("default") profile.
export default {
